...
#     _, subtitle_path = audio_files.get_block_and_subtitle_file_from_sentence_text(sentence_text)
...
#     _, subtitle_path2 = audio_files.get_block_and_subtitle_file_from_sentence_text(sentence_text2)
#     sound_line2 = audio_files.get_sound_line_from_block_and_path(block2, subtitle_path2)
...
def remove_edge_new_sentence_new_sound_file_test():
    ...
    # sound_line_check3 = "[sound:太宰治 - 西村俊彦`ABCD`03h30m30s004ms-03h30m32s820ms`3804-3804.mp3]"
    # sound_line3 = "[sound:太宰治_-_西村俊彦`ABCD`03h30m30s004ms-03h30m37s408ms`3804-3805.mp3]"
    # relative_index3 = 1
...
#     menu.generate_fields_sound_sentence_image(sound_line1, 2, sentence_text1, 0, "", 3)

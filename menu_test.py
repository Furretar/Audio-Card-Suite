...
- 我來舔您的鞋子吧"""
    relative_index1 = 1
    new_sound_tag1, target_sentence_text1 = menu.generate_file_from_context_sound_and_sentence_line(sound_line1, sentence_text1, relative_index1)
    ...
    relative_index2 = 1
    new_sound_tag2, target_sentence_text2 = menu.generate_file_from_context_sound_and_sentence_line(sound_line2, sentence_text2, relative_index2)
    ...
    sound_line3 = ""
    relative_index3 = 1
    new_sound_tag3, new_sentence_text3 = menu.generate_file_from_context_sound_and_sentence_line(sound_line3, sentence_text3, relative_index3)
